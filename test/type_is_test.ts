...
test("typeofrequest(header, types) given multiple types should return the first match or false", function () {
  ...
  assertStrictEquals(
    typeofrequest(header, ["image/*", "image/png"]),
    "image/png",
  );
  assertStrictEquals(
    typeofrequest(header, ["image/png", "image/*"]),
    "image/png",
  );
...
test('typeofrequest(header, types) given "*/*" should match any content-type', function () {
  ...
  assertStrictEquals(
    typeofrequest(createHeader("text/xml"), ["*/*"]),
    "text/xml",
  );
  assertStrictEquals(
...
test('should match "urlencoded"', function () {
  ...
  assertStrictEquals(
    typeofrequest(header, ["json", "urlencoded"]),
    "urlencoded",
  );
  assertStrictEquals(
    typeofrequest(header, ["urlencoded", "json"]),
    "urlencoded",
  );
});
...
test('typeofrequest(header, types) when Content-Type: multipart/form-data should match "multipart/*"', function () {
  ...
  assertStrictEquals(
    typeofrequest(header, ["multipart/*"]),
    "multipart/form-data",
  );
});
